...
selected_data_fromschool <- fromschool_data %>% filter(schoolindex == 1) %>% group_by(school) %>%
...
p + geom_text(aes(label=paste(school,tot), y = text_y), nudge_x = 0.7, size = 6 )
=======
...
>>>>>>> 911b10c716a64543bd77f7bb570f35553ba7adf9


# scale_fill_manual(values = c("#FF00FF", "#FF1CFF", "#FF33FF", "#FF4CFF", "#FF66FF", "#FF7FFF"))
##################################################################################################여기까지
...
a = paste(etc_label$school,'(',etc_label$tot,')', collapse = ', ', sep="")
print(a)
