...
```{r pressure, echo=FALSE, fig.height=4, fig.width=9, message=FALSE, warning=FALSE}
...
g <- ggtexttable(stan1, rows = NULL, theme = ttheme(tbody.style = tbody_style(fill = 'white'), padding = unit(c(5, 20), "mm")))
# , padding = unit(c(20, 30), "mm"))
