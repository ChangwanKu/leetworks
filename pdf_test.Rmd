...
=======
geometry: margin=1in
>>>>>>> f33f6c33983045aab2d1565509cf1f89cb3d8ddb
...
#ggarrange(mojip,standa rd_table,ncol = 2, nrow = 1)
subchunkify(grid.arrange(mojip_plot, standard_table, ncol = 2), 2.3, 7)
...
subchunkify(myschoolbarplot, 2.3, 7)
...
foreign_plot <- ggplot(foreign,aes(key,value)) + geom_bar(stat='identity',width = 0.5, fill='#FF00FF',family="") + 
  ...
  theme(axis.ticks = element_blank(),axis.title = element_blank(), 
        ...
        panel.grid.major.y = element_line(color = 'gray'), 
        panel.grid.minor.y = element_line(color='gray'))
subchunkify(foreign_plot, 2.3, 7)
...
#fromschool 출력
subchunkify(fromschool_plot_2015, 3, 3)
...
#fromschool 출력
subchunkify(fromschool_plot_2016, 3, 3)
